...
{
    const EVENT_BEFORE_SUBMIT = 'onBeforeSubmit';
    ...
    /** @var string */
    private $schemaVersion = '1.1.3';

    /** @var string */
    private $pluginName = 'Freeform Lite';
    ...
    /** @var string */
    private $developerUrl = 'https://solspace.com/craft/freeform';
    ...
    {
        if (isset(craft()->freeform_settings) && craft()->freeform_settings->getPluginName()) {
            return craft()->freeform_settings->getPluginName();
        }
