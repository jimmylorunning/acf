...
class Freeform_SubmissionModel extends BaseElementModel
{
     ...
     */
    public function getAssetModels($fieldColumnHandle)
    {
    ...
    public function __get($name)
    {
        ...
        if (array_key_exists($name, $fields)) {
            ...
            $clone = clone $field;
            $clone->setValue(parent::__get($fieldColumnName));

            if ($clone instanceof CheckboxField) {
                $clone->setIsChecked((bool) parent::__get($fieldColumnName));
            }
